...
For the browse page for collections, we need to first create the directory: `/default/view/omeka/site/collection`

Then we can copy `/application/view/omeka/site/collection/browse.phtml` 
to `/default/view/omeka/site/collection/browse.phtml`
